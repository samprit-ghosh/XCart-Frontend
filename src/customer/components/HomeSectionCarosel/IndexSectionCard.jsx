...
function IndexSectionCard({ product }) {
  ...
  return (
    <div
      ...
      className='cursor-pointer h-[17rem] flex flex-col bg-white rounded-lg shadow-[0_4px_10px_8px_rgba(0,0,0,0.1)] overflow-hidden w-[15rem] mx-2 sm:mx-3 md:mx-4 lg:mx-5'
    >
...
export default IndexSectionCard;