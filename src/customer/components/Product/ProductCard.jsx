  ...
  return (
    ...
    >
      ...
      <div className="p-4 space-y-2">
        ...
        <p className="text-[#213547] text-lg  font-medium">{product.brand}</p>

        {/* Price Section */}
        <div className="flex items-center space-x-2">
          <p className="text-[#213547] text-lg font-semibold">₹{product.price}</p>
          <p className="text-[#213547] line-through opacity-50 text-sm">₹{product.discountedPrice}</p>
