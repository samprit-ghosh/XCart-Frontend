    ...
    <div className="p-4 sm:p-5 shadow-[0_4px_10px_8px_rgba(0,0,0,0.1)] mb-5">
      <div className="flex flex-col sm:flex-row items-center sm:items-start">
        ...
        <div className="mt-3 sm:ml-5 sm:mt-0 text-center sm:text-left">
          ...
          <p className=" text-gray-800 opacity-70 text-xs sm:text-sm">Size: L, White</p>
          <p className=" text-gray-800 opacity-70 text-xs sm:text-sm mt-1">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mt-4">
        ...
        <div className="flex items-center justify-center sm:justify-start space-x-2">
          ...
          <span className=" text-black py-1 px-6 border rounded-sm text-sm sm:text-base">
            1
          </span>
          <IconButton>
