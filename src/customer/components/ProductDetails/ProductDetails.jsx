...
export default function ProductDetails() {
  ...
  return (
    <div className="bg-gray-200 pt-30 pb-30">
      ...
      {selectedImage && (
        <div
          className="fixed inset-0 z-50 flex items-center justify-center bg-gray-800 p-10  bg-opacity-75 transition duration-300 cursor-pointer"
          // onClick={closeImage}
        >


  <CloseIcon   style={{ width: "35px", height: "35px" }}
    className="absolute  top-7 right-50 bg-white text-black rounded-full p-2 shadow-lg hover:bg-gray-200 transition " 
    onClick={closeImage}
  />
  ...
  />
        ...
        <section className="mb-20">
          <h2 className="py-3 px-5 mb-10 font-bold text-gray-800 text-2xl lg:text-3xl">Recent Reviews</h2>
          <div className="shadow-[0_4px_10px_8px_rgba(0,0,0,0.1)] p-5 m-5">
            <Grid container spacing={4}>
              ...
              <Grid item xs={12} md={5}>
                <h2 className="text-xl text-gray-800 font-semibold pb-1">Product Rating</h2>
                <div className="flex items-center space-x-3">
                  <Rating value={4.6} precision={0.5} readOnly />
                  <p className=" text-gray-800 opacity-60">56,564 Ratings</p>
                </div>
                ...
                <Box sx={{ marginTop: "15px" }}>
                  {ratings.map((rating, index) => (
                    <Grid container gap={2} alignItems="center" key={index} sx={{ marginBottom: 1 }}>
                      <Grid item xs={4} sm={3}>
                        <p className=" text-gray-800 text-sm sm:text-base">{rating.label}</p>
                      </Grid>
                      <Grid item xs={8} sm={9}>
        ...
        <section className="pt-5">
          <h2 className=" text-gray-800 py-5 mb-8 px-5 font-bold text-2xl lg:text-3xl">Similar Products</h2>
